          ...
          <div className="flex flex-col md:flex-row h-full">
            ...
            <span className="text-2xl font-bold lg:text-2xl text-blue-400 border-b-2 border-dotted border-gray-800 pb-2 ">
              ...
              <span className="text-gray-200 text-lg mt-2">
                ...
                its <span className="bg-white px-1 text-slate-900 rounded-sm">web apps</span> or <span className="bg-white px-1 text-slate-900 rounded-sm">desktop</span> applications, I’m all in! I'm also well-versed in <span className="bg-white px-1 text-slate-900 rounded-sm">Java with SpringBoot </span>
