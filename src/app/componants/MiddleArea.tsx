  ...
  return (
    <>
      ...
      <div className="p-4 lg:p-8 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
        {/* First Card */}
        <div
  className={`${showDetails['card1'] ? 'max-h-[920px]' : 'max-h-[518px]'} bg-white opacity-95 text-white flex flex-col justify-top items-center border-2 border-white`}
>
          ...
          {showDetails['card1'] && (
            <>
              <ul className="list-disc pl-10">
                <li className="text-slate-800 pl-2 pr-2 mb-2 leading-tight">A deep understanding of manual accounting practices.</li>
                <li className="text-slate-800 pl-2 pr-2 mb-2 leading-tight">Expert knowledge of GST, directly from a professional consultant.</li>
        ...
        {/* Second Card */}
        <div
  className={`${showDetails['card2'] ? 'max-h-[920px]' : 'max-h-[518px]'} bg-white opacity-95 text-white flex flex-col justify-top items-center border-2 border-white`}>   <Link href="https://www.facebook.com/profile.php?id=61567655038718">
            <Image
              src="./tallythumb.png"
              alt="accounting"
              width={307}
          ...
          {showDetails['card2'] && (
            <>
              <ul className="list-disc pl-10">
                <li className="text-slate-800 pl-2 pr-2 mb-2 leading-tight">Learn manual accounting and GST from a professional trainer with years of Tally expertise.</li>
                <li className="text-slate-800 pl-2 pr-2 mb-2 leading-tight">Gain the skills and confidence to work with Tally for business accounting.</li>
        ...
        <div
  className={`${showDetails['card3'] ? 'max-h-[920px]' : 'max-h-[518px]'} bg-white opacity-95 text-white flex flex-col justify-top items-center border-2 border-white`}>   <Link href="https://www.facebook.com/profile.php?id=61567655038718">
            <Image
              ...
              priority
            />
            <h1 className="text-slate-950 text-xl p-3 font-semibold leading-tight">Master Your Accounting Skill with our GST course in Cherpulassery!</h1>
          </Link>
          <p className="text-slate-800 pl-2 pr-2 leading-tight">
          Are you ready to build a career in accounting or upgrade your financial management skills? Our Complete Accounting Course—covering GST 
          expertise you need, whether you are a beginner or an experienced learner looking to expand your knowledge. Led by a seasoned <strong> Tally expert with years of industry experience</strong>
          </p>
          <button
            className="bg-slate-950 p-1 px-2 cursor-pointer m-4 self-end"
          ...
          {showDetails['card3'] && (
            <>
              <ul className="list-disc pl-10">
                <li className="text-slate-800 pl-2 pr-2 mb-2 leading-tight">This course delivers hands-on learning, practical knowledge, and a solid foundation for real-world application.</li>
              ...
              <p className="text-slate-800 p-2 leading-tight">
                ...
                <div
  className={`${showDetails['card4'] ? 'max-h-[920px]' : 'max-h-[518px]'} bg-white opacity-95 text-white flex flex-col justify-top items-center border-2 border-white`}>   <Link href="https://www.facebook.com/profile.php?id=61567655038718">
            <Image
          ...
          {showDetails['card4'] && (
            <>
              <ul className="list-disc pl-10">
                <li className="text-slate-800 pl-2 pr-2 mb-2 leading-tight">Professional, career-focused training in SAP and Tally.</li>
                <li className="text-slate-800 pl-2 pr-2 mb-2 leading-tight">Personalized guidance from an experienced trainer.</li>
                <li className="text-slate-800 pl-2 pr-2 mb-2 leading-tight">Convenient access for residents of nearby towns</li>
              </ul>
              <p className="text-slate-800 p-2 leading-tight">
              Our training center is located in <strong>Cherpulassery</strong>, accessible to students and professionals from <strong> Pattambi, Koppam, Shornur, Perinthalmanna, Mannarkad, Ottapalam, and Kongad</strong>.
              </p>
            </>
          )}
        </div>
